...
WORKINGDIR="/tmp/grumpycoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="http://downloads.sourceforge.net/project/grumpycoin/GrumpyCoin/grumpycoin-0.8.99/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="http://downloads.sourceforge.net/project/grumpycoin/GrumpyCoin/"
VERSIONPREFIX="grumpycoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'grumpycoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[grumpycoin-]<version>-[rc[0-9]] (example: grumpycoin-0.7.1-rc1)"
   echo "wget output:"
