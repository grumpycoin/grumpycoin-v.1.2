...
unlocked to sign the GrumpyCoin-Qt.app bundle.
...
allowing somebody to distribute a GrumpyCoin-Qt.app or grumpycoin-qt-setup.exe with a valid
...
that the grumpycoin-qt.exe file inside the installer had not been tampered with.
