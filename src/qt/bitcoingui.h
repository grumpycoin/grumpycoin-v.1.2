#ifndef GRUMPYCOINGUI_H
#define GRUMPYCOINGUI_H
...
/**
  GrumpyCoin GUI main class. This class represents the main window of the GrumpyCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GrumpyCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GrumpyCoinGUI(bool fIsTestnet = false, QWidget *parent = 0);
    ~GrumpyCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a grumpycoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
