...
#ifndef GRUMPYCOIN_MAIN_H
#define GRUMPYCOIN_MAIN_H
...
// per block, which means about 160 tp

struct CBlockIndexWorkComparator;

/*Clarv added global parameter*/
static const unsigned int KGW_BLOCK_START =20333;
//Explot fix https://bitcointalk.org/index.php?topic=552895
static const unsigned int KGW_BLOCK_START_EXPLOITFIX =48200;
...
public:
    ...
    */
    ...
    /** Amount of grumpycoins spent by this transaction.
    ...
    /** Amount of grumpycoins coming in to this transaction
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 576 / 250; // GrumpyCoin: (1440) blocks found a day. Priority cutoff is 1 coin day / 250 bytes.
    }
