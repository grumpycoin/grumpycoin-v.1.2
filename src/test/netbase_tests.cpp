...
{
    BOOST_CHECK(TestSplitHost("www.grumpyco.in", "www.grumpyco.in", -1));
    BOOST_CHECK(TestSplitHost("[www.grumpyco.in]", "www.grumpyco.in", -1));
    BOOST_CHECK(TestSplitHost("www.grumpyco.in:80", "www.grumpyco.in", 80));
    BOOST_CHECK(TestSplitHost("[www.grumpyco.in]:80", "www.grumpyco.in", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:55904", "127.0.0.1", 55904));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:55904", "127.0.0.1", 55904));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:55904", "::ffff:127.0.0.1", 55904));
    BOOST_CHECK(TestSplitHost("[::]:55904", "::", 55904));
    BOOST_CHECK(TestSplitHost("::55904", "::55904", -1));
    BOOST_CHECK(TestSplitHost(":55904", "", 55904));
    BOOST_CHECK(TestSplitHost("[]:55904", "", 55904));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:55904", "127.0.0.1:55904"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:55904", "[::]:55904"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
